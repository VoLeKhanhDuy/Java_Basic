...
public class Bai2 {
	...
	public static void main(String[] args) {
		...
		int k = scan.nextInt();
		if(find(a, k) == -1) System.out.println("Không tìm thấy giá trị xuất hiện đầu tiên trong mảng");
		...
		sn.printArray(a);
		System.out.print("\nMảng đối xứng: ");
		sn.printArray(sn.reverseArray(a));
	...
	{
		int mangDoiSo[] = new int[mang.length];
		for(int i = mang.length -1; i >= 0; i--)
		{
			mangDoiSo[mang.length - 1 - i] = mang[i];
		}
		return mangDoiSo;
